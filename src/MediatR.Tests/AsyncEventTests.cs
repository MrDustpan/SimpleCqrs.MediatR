namespace MediatR.Tests
{
    ...
    {
        public class Ping : IAsyncEvent
        {
            public string Message { get; set; }
        }

        public class PongHandler : IAsyncEventHandler<Ping>
        {
        ...
        public class PungHandler : IAsyncEventHandler<Ping>
        {
            private readonly TextWriter _writer;
        ...
        public void Should_resolve_main_handler()
        {
            ...
            var container = new Container(cfg =>
            {
                cfg.Scan(scanner =>
                {
                    ...
                    scanner.AddAllTypesOf(typeof (IAsyncEventHandler<>));
                });
